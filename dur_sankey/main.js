...
var author$project$Ports$updateChartSeries = _Platform_outgoingPort('updateChartSeries', elm$json$Json$Encode$string);
var author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		{filename: '', path: flags.rootName, sankeyLinks: _List_Nil, sankeyNodes: _List_Nil},
		author$project$Ports$updateChartSeries(flags.rootName));
};
var author$project$Main$SetPath = function (a) {
	return {$: 'SetPath', a: a};
};
var author$project$Main$SetSankey = function (a) {
	return {$: 'SetSankey', a: a};
};
var elm$json$Json$Decode$string = _Json_decodeString;
var author$project$Ports$setPath = _Platform_incomingPort('setPath', elm$json$Json$Decode$string);
var elm$json$Json$Decode$value = _Json_decodeValue;
var author$project$Ports$setSankey = _Platform_incomingPort('setSankey', elm$json$Json$Decode$value);
var elm$core$Platform$Sub$batch = _Platform_batch;
var author$project$Main$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				author$project$Ports$setPath(author$project$Main$SetPath),
				author$project$Ports$setSankey(author$project$Main$SetSankey)
			]));
};
var author$project$Main$Link = F2(
	function (dPath, width) {
		return {dPath: dPath, width: width};
	});
var author$project$Main$Node = F5(
	function (funcPath, x0, y0, x1, y1) {
		return {funcPath: funcPath, x0: x0, x1: x1, y0: y0, y1: y1};
	});
		...
		if (msg.$ === 'SetPath') {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{path: path}),
				author$project$Ports$updateChartSeries(path));
		} else {
			var value = msg.a;
			var nodes = A2(
				...
				A2(
					...
					elm$json$Json$Decode$list(
						A6(
							...
							A2(elm$json$Json$Decode$field, 'funcPath', elm$json$Json$Decode$string),
							A2(elm$json$Json$Decode$field, 'x0', elm$json$Json$Decode$float),
							A2(elm$json$Json$Decode$field, 'y0', elm$json$Json$Decode$float),
				...
				A2(
					...
					elm$json$Json$Decode$list(
						A3(
							...
							A2(elm$json$Json$Decode$field, 'dPath', elm$json$Json$Decode$string),
			...
			var filename = A2(
				...
				value);
			var _n1 = _Utils_Tuple3(nodes, links, filename);
			if (((_n1.a.$ === 'Ok') && (_n1.b.$ === 'Ok')) && (_n1.c.$ === 'Ok')) {
				var nodes_ = _n1.a.a;
				var links_ = _n1.b.a;
				var filename_ = _n1.c.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{filename: filename_, sankeyLinks: links_, sankeyNodes: nodes_}),
...
var author$project$Main$view = function (model) {
	var pathArray = elm$core$Array$fromList(
		A2(elm$core$String$split, '/', model.path));
	return A2(
									...
									return A2(
										...
										_List_fromArray(
											[
												...
												author$project$Main$SetPath(
													A2(
														elm$core$String$join,
														'/',
														elm$core$Array$toList(
															A3(elm$core$Array$slice, 0, index + 1, pathArray))))),
												mdgriffith$elm_ui$Element$Background$color(
												A3(mdgriffith$elm_ui$Element$rgb255, 61, 90, 254)),
												...
												_List_fromArray(
													[
														mdgriffith$elm_ui$Element$Background$color(
														A3(mdgriffith$elm_ui$Element$rgb255, 26, 35, 126))
													]))
											]),
										mdgriffith$elm_ui$Element$text(nodeName));
								}),
							pathArray))),
					A2(
					mdgriffith$elm_ui$Element$row,
							...
							A2(
								...
								_List_fromArray(
									[
										...
										elm$html$Html$Attributes$id('chartElementId')
									]),
								_List_Nil))
						])),
					(model.filename !== '') ? A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									mdgriffith$elm_ui$Element$text(model.filename))
								])),
							A2(
							mdgriffith$elm_ui$Element$row,
							_List_fromArray(
									...
									A2(
										...
										_List_fromArray(
											[
												...
												elm$svg$Svg$Attributes$viewBox('0 0 1200 600')
											]),
										_List_fromArray(
											[
												A2(
												...
												_List_fromArray(
													[
														...
														elm$svg$Svg$Attributes$stroke('#070'),
														elm$svg$Svg$Attributes$strokeOpacity('0.2')
													]),
												A2(
													elm$core$List$map,
													function (link) {
														return A2(
															...
															_List_fromArray(
																[
																	elm$svg$Svg$Attributes$d(link.dPath),
																	elm$svg$Svg$Attributes$strokeWidth(
																	elm$core$String$fromFloat(link.width))
																]),
															_List_fromArray(
																[
																	A2(
															...
															[
																...
																_List_fromArray(
																	[
																		...
																		elm$core$String$fromFloat(node.x0)),
																		elm$svg$Svg$Attributes$y(
																		elm$core$String$fromFloat(node.y0)),
																		elm$svg$Svg$Attributes$fill('#386'),
																		elm$svg$Svg$Attributes$height(
																		elm$core$String$fromFloat(node.y1 - node.y0)),
																		elm$svg$Svg$Attributes$width(
																		elm$core$String$fromFloat(node.x1 - node.x0))
																	]),
																_List_Nil),
																A2(
																elm$svg$Svg$text_,
																_List_fromArray(
																	[
																		elm$svg$Svg$Attributes$x(
																		elm$core$String$fromFloat(node.x0 - 6)),
																		elm$svg$Svg$Attributes$y(
																		elm$core$String$fromFloat((node.y1 + node.y0) / 2)),
																	...
																	[
																		...
																		A2(
																			...
																			elm_community$list_extra$List$Extra$last(
																				A2(elm$core$String$split, '/', node.funcPath))))
																	]))
															]);
													},
													model.sankeyNodes))
...
_Platform_export({'Main':{'init':author$project$Main$main(
	A2(
		...
		A2(elm$json$Json$Decode$field, 'rootName', elm$json$Json$Decode$string)))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Json.Decode.Value":{"args":[],"type":"Json.Encode.Value"}},"unions":{"Main.Msg":{"args":[],"tags":{"SetPath":["String.String"],"SetSankey":["Json.Decode.Value"]}},"String.String":{"args":[],"tags":{"String":[]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}}}}})}});}(this));