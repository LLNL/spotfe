...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../../web/js/DBStorage.js":[function(require,module,exports) {
...
DB.init = function (callback) {
  DB.open = indexedDB.open(DB.cacheStore); // Create the schema

  DB.open.onupgradeneeded = function () {
    DB.db = DB.open.result;
    DB.store = DB.db.createObjectStore(DB.cacheStore, {
      keyPath: "id"
    });
  };
...
DB.save = function (id, obj, callback) {
  ...
  store.onsuccess = function (ret) {//callback( ret );
  };
...
var onceGetSummary = function onceGetSummary() {
  if (!window.onceGetSum) {
    window.onceGetSum = 1; //  ideally this should be guaranteed to happen before the getData call.
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","../../web/js/DBStorage.js"], null)