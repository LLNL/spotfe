...
{
	if (region.aS.ae === region.a3.ae)
	{
		return 'on line ' + region.aS.ae;
	}
	return 'on lines ' + region.aS.ae + ' through ' + region.a3.ae;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {a6: fragment, bb: host, br: path, bt: port_, bw: protocol, bx: query};
	});
...
var $author$project$Main$Quantitative = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Main$metaDecoder = A2(
		...
		$elm$json$Json$Decode$oneOf(
			_List_fromArray(
				[
					...
					F2(
						function (typ, val) {
							return (typ === 'date') ? $author$project$Main$Timestamp(
								A2(
									...
									A2(
										...
										$elm$core$String$toInt(val)))) : (A2(
								$elm$core$List$member,
								typ,
								_List_fromArray(
									['int', 'double', 'long', 'unsigned int', 'unsigned double', 'unsigned long', 'signed int', 'signed double', 'signed long'])) ? $author$project$Main$Quantitative(
								A2(
									$elm$core$Maybe$withDefault,
									0,
									$elm$core$String$toFloat(val))) : $author$project$Main$Nominal(val));
						}),
					...
					F2(
						function (_v0, val) {
							return $author$project$Main$Quantitative(val);
						}),
					A2($elm$json$Json$Decode$field, 'type', $elm$json$Json$Decode$string),
...
var $author$project$Main$init = function (flags) {
	var runDecoder = A3(
		...
		F2(
			function (met, dat) {
				return {ad: dat, ay: met};
			}),
		$author$project$Main$metaDecoder,
		A2(
			$elm$json$Json$Decode$field,
			'data',
			$elm$json$Json$Decode$dict(
	...
	var run = function () {
		var _v0 = A2($elm$json$Json$Decode$decodeValue, runDecoder, flags);
		if (!_v0.$) {
			var val = _v0.a;
			return val;
		} else {
			var error = _v0.a;
			return {ad: $elm$core$Dict$empty, ay: $elm$core$Dict$empty};
		}
	}();
	var filename = A2(
...
var $mdgriffith$elm_ui$Internal$Model$asColumn = 1;
var $mdgriffith$elm_ui$Internal$Style$classes = {bR: 'a', aC: 'atv', bT: 'ab', bU: 'cx', bV: 'cy', bW: 'acb', bX: 'accx', bY: 'accy', bZ: 'acr', aY: 'al', aZ: 'ar', b_: 'at', aD: 'ah', aE: 'av', b0: 's', b4: 'bh', b5: 'b', b7: 'w7', b9: 'bd', ca: 'bdt', an: 'bn', cb: 'bs', ap: 'cpe', ch: 'cp', ci: 'cpx', cj: 'cpy', D: 'c', ar: 'ctr', as: 'cb', at: 'ccx', E: 'ccy', ac: 'cl', au: 'cr', cl: 'ct', cm: 'cptr', cn: 'ctxt', ct: 'fcs', a5: 'focus-within', cu: 'fs', cv: 'g', aI: 'hbh', aJ: 'hc', a9: 'he', aK: 'hf', ba: 'hfp', cy: 'hv', cA: 'ic', cC: 'fr', cF: 'iml', cG: 'imlf', cH: 'imlp', cI: 'implw', cJ: 'it', cK: 'i', bi: 'lnk', X: 'nb', bl: 'notxt', cR: 'ol', cT: 'or', O: 'oq', cX: 'oh', bp: 'pg', bq: 'p', cY: 'ppe', c_: 'ui', u: 'r', c0: 'sb', c1: 'sbx', c2: 'sby', c3: 'sbt', c5: 'e', c6: 'cap', c7: 'sev', dd: 'sk', p: 't', dh: 'tc', di: 'w8', dj: 'w2', dk: 'w9', dl: 'tj', aA: 'tja', dm: 'tl', dn: 'w3', $7: 'w5', dp: 'w4', dq: 'tr', dr: 'w6', ds: 'w1', dt: 'tun', bH: 'ts', R: 'clr', dy: 'u', aU: 'wc', bM: 'we', aV: 'wf', bN: 'wfp', aW: 'wrp'};
...
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.b0 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.c5);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.w)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.c8.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.c8.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.u) + ('-' + ($elm$core$String$fromInt(pos.ck) + ('-' + ($elm$core$String$fromInt(pos.bL) + ('-' + $elm$core$String$fromInt(pos.a8)))))));
		case 11:
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cy, $mdgriffith$elm_ui$Internal$Style$classes.R)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cy, $mdgriffith$elm_ui$Internal$Style$classes.O)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							...
							'grid-column: ' + ($elm$core$String$fromInt(position.ck) + (' / ' + ($elm$core$String$fromInt(position.ck + position.bL) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.u) + ('-' + ($elm$core$String$fromInt(position.ck) + ('-' + ($elm$core$String$fromInt(position.bL) + ('-' + $elm$core$String$fromInt(position.a8)))))));
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.c6 + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.p + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.c6 + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.p)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {a8: height / size, Y: size, bJ: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.ce, adjustment.b3, adjustment.co, adjustment.cL]);
	var lineHeight = 1.5;
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.b0 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.c5))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.b0, $mdgriffith$elm_ui$Internal$Style$classes.c5, $mdgriffith$elm_ui$Internal$Style$classes.ar, $mdgriffith$elm_ui$Internal$Style$classes.E, $mdgriffith$elm_ui$Internal$Style$classes.bZ])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.b0, $mdgriffith$elm_ui$Internal$Style$classes.c5, $mdgriffith$elm_ui$Internal$Style$classes.ar, $mdgriffith$elm_ui$Internal$Style$classes.E, $mdgriffith$elm_ui$Internal$Style$classes.bX])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.b0, $mdgriffith$elm_ui$Internal$Style$classes.c5, $mdgriffith$elm_ui$Internal$Style$classes.ar, $mdgriffith$elm_ui$Internal$Style$classes.bY])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.b0, $mdgriffith$elm_ui$Internal$Style$classes.c5, $mdgriffith$elm_ui$Internal$Style$classes.ar, $mdgriffith$elm_ui$Internal$Style$classes.bW])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.b0 + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.p + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aU + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aJ)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.b0 + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.p + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aV + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aK)))));
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.X, $mdgriffith$elm_ui$Internal$Style$classes.c5, $mdgriffith$elm_ui$Internal$Style$classes.bR]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.X, $mdgriffith$elm_ui$Internal$Style$classes.c5, $mdgriffith$elm_ui$Internal$Style$classes.b5]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.X, $mdgriffith$elm_ui$Internal$Style$classes.c5, $mdgriffith$elm_ui$Internal$Style$classes.cT]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.X, $mdgriffith$elm_ui$Internal$Style$classes.c5, $mdgriffith$elm_ui$Internal$Style$classes.cR]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.X, $mdgriffith$elm_ui$Internal$Style$classes.c5, $mdgriffith$elm_ui$Internal$Style$classes.cC]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.X, $mdgriffith$elm_ui$Internal$Style$classes.c5, $mdgriffith$elm_ui$Internal$Style$classes.b4]));
						}
					}())
				]),
			_List_fromArray(
...
var $mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.aE + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.b_);
		case 2:
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{ct: $elm$core$Maybe$Nothing, cy: $elm$core$Maybe$Nothing, cN: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.c_, $mdgriffith$elm_ui$Internal$Style$classes.b0, $mdgriffith$elm_ui$Internal$Style$classes.c5]))),
...
var $mdgriffith$elm_ui$Element$scrollbarX = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$overflow, $mdgriffith$elm_ui$Internal$Style$classes.c1);
var $mdgriffith$elm_ui$Element$scrollbars = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$overflow, $mdgriffith$elm_ui$Internal$Style$classes.c0);
...
var $author$project$Main$children = F2(
	function (keys, mPath) {
		if (!mPath.$) {
			var path = mPath.a;
			return A2(
				$elm$core$List$filter,
				function (runPath) {
					return A2($elm$core$String$startsWith, path, runPath) && (($elm$core$List$length(
						A2($elm$core$String$split, '/', runPath)) - $elm$core$List$length(
						A2($elm$core$String$split, '/', path))) === 1);
				},
				keys);
		} else {
			return $elm$core$List$singleton(
				A2(
					$elm$core$Maybe$withDefault,
					'',
					A2($elm_community$list_extra$List$Extra$minimumBy, $elm$core$String$length, keys)));
		}
	});
...
var $avh4$elm_color$Color$fromRgba = function (components) {
	return A4($avh4$elm_color$Color$RgbaSpace, components.aP, components.aH, components.aF, components.T);
};
...
var $mdgriffith$elm_ui$Element$toRgb = function (_v0) {
	...
	var b = _v0.c;
	var a = _v0.d;
	return {T: a, aF: b, aH: g, aP: r};
};
var $author$project$Main$colorHash = F2(
	function (text, alpha) {
		var _v0 = A2(
			$elm$core$List$map,
			A2(
		...
		if (((_v0.b && _v0.b.b) && _v0.b.b.b) && (!_v0.b.b.b.b)) {
			...
			return $avh4$elm_color$Color$fromRgba(
				$mdgriffith$elm_ui$Element$toRgb(
					A4($mdgriffith$elm_ui$Element$rgba255, a, b, c, alpha)));
		} else {
			return $avh4$elm_color$Color$black;
		}
	});
var $mdgriffith$elm_ui$Element$fromRgb = function (clr) {
	return A4($mdgriffith$elm_ui$Internal$Model$Rgba, clr.aP, clr.aH, clr.aF, clr.T);
};
...
var $author$project$Main$elColor = function (c) {
...
var $author$project$Main$viewFlameGraph = F3(
	function (data, widthValueRatio, nodePath) {
		var nodeValue = A2(
			$elm$core$Maybe$withDefault,
			0,
			A2($elm$core$Dict$get, nodePath, data));
		var nodeName = A2(
			$elm$core$Maybe$withDefault,
			'',
			$elm_community$list_extra$List$Extra$last(
				A2($elm$core$String$split, '/', nodePath)));
		var funcPaths = $elm$core$Dict$keys(data);
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$px(
								$elm$core$Basics$round(widthValueRatio * nodeValue))),
							...
							$author$project$Main$elColor(
								A2($author$project$Main$colorHash, nodePath, 0.6))),
							$mdgriffith$elm_ui$Element$Border$color(
							$author$project$Main$elColor($avh4$elm_color$Color$black))
						]),
					A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
						...
						$mdgriffith$elm_ui$Element$text(
							nodeName + (' (' + ($elm$core$String$fromFloat(nodeValue) + ')'))))),
					A2(
					...
					A2(
						$elm$core$List$map,
						A2($author$project$Main$viewFlameGraph, data, widthValueRatio),
						A2(
							$author$project$Main$children,
							funcPaths,
							$elm$core$Maybe$Just(nodePath))))
				]));
	});
...
var $author$project$Main$toMonth = function (month) {
	switch (month) {
		case 0:
			return 'Jan';
		case 1:
...
var $author$project$Main$toDateString = function (millis) {
	var pox = $elm$time$Time$millisToPosix(millis);
	return $elm$core$String$concat(
		_List_fromArray(
			[
				$elm$core$String$fromInt(
				A2($elm$time$Time$toYear, $elm$time$Time$utc, pox)),
				'-',
				$author$project$Main$toMonth(
				A2($elm$time$Time$toMonth, $elm$time$Time$utc, pox)),
				'-',
				$elm$core$String$fromInt(
				A2($elm$time$Time$toDay, $elm$time$Time$utc, pox)),
				' ',
				$elm$core$String$fromInt(
				A2($elm$time$Time$toHour, $elm$time$Time$utc, pox)),
				':',
				A3(
				$elm$core$String$pad,
				2,
				'0',
				$elm$core$String$fromInt(
					A2($elm$time$Time$toMinute, $elm$time$Time$utc, pox)))
			]));
};
var $author$project$Main$viewGlobals = function (meta) {
	var nomView = A2(
		$elm$core$List$map,
		function (_v0) {
			var k = _v0.a;
			...
			var textVal = function () {
				switch (v.$) {
					...
					default:
						var t = v.a;
						return $author$project$Main$toDateString(t);
				}
			}();
			return A2(
				$mdgriffith$elm_ui$Element$row,
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$text(textVal))
					]));
		},
	...
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$width(
				$mdgriffith$elm_ui$Element$px($author$project$Main$h))
			]),
		nomView);
};
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$text('Run: ' + model.aG)),
					A2(
					$mdgriffith$elm_ui$Element$column,
					_List_fromArray(
						[
					...
					function () {
						var metrics = $elm$core$Dict$keys(
							A2(
								$elm$core$Maybe$withDefault,
								$elm$core$Dict$empty,
								A2(
									...
									A2(
										...
										$elm$core$Array$fromList(
											$elm$core$Dict$toList(model.af.ad))))));
						return A2(
							$elm$core$List$map,
							function (metric) {
								return A2(
									...
									function () {
										...
										var data = A2(
											$elm$core$Dict$map,
											F2(
												function (funcPath, vals) {
													return A2(
														$elm$core$Maybe$withDefault,
														0,
														A2($elm$core$Dict$get, metric, vals));
												}),
											model.af.ad);
										var rootPath = A2(
											$elm$core$Maybe$withDefault,
										...
										var rootValue = A2(
											$elm$core$Maybe$withDefault,
											0,
											A2($elm$core$Dict$get, rootPath, data));
										return A2(
											$mdgriffith$elm_ui$Element$column,
											_List_fromArray(
												[
											...
											_List_fromArray(
												[
													$mdgriffith$elm_ui$Element$text(metric),
													A3($author$project$Main$viewFlameGraph, data, flameWidth / rootValue, rootPath)
												]));
									}());
							},
							metrics);
					...
					$author$project$Main$viewGlobals(model.af.ay))
				])));
};
