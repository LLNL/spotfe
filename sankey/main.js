...
var $author$project$Main$init = function (flags) {
	...
	var run = function () {
		...
		if (_v0.$ === 'Ok') {
			...
			var error = _v0.a;
			return {data: $elm$core$Dict$empty, meta: $elm$core$Dict$empty};
		}
	}();
	var filename = A2(
...
var $author$project$Main$addInclusiveNode = F3(
	function (data, accumulator, nodeName) {
		var val = A2(
			$elm$core$Maybe$withDefault,
			0,
			A2($elm$core$Dict$get, nodeName, data));
		var childrenNames = A2(
			$author$project$Main$children,
			$elm$core$Dict$keys(data),
			$elm$core$Maybe$Just(nodeName));
		if (!$elm$core$List$length(childrenNames)) {
			return A3(
			...
			var accumWithMyChildren = A3(
				$elm$core$List$foldl,
				F2(
					function (name, accum) {
						return A3($author$project$Main$addInclusiveNode, data, accum, name);
					}),
				accumulator,
				childrenNames);
			var childrenSum = A3(
				...
				F2(
					function (name, total) {
						var v = A2(
							$elm$core$Maybe$withDefault,
							_Utils_Tuple2(0, 0),
							A2($elm$core$Dict$get, name, accumWithMyChildren));
						return total + A2($elm$core$Basics$max, v.a, v.b);
					}),
				0,
				childrenNames);
			return A3(
				$elm$core$Dict$insert,
				nodeName,
				_Utils_Tuple2(val, childrenSum),
				accumWithMyChildren);
		}
	});
var $author$project$Main$addInclusive = function (data) {
	return A3(
		$author$project$Main$addInclusiveNode,
		data,
		$elm$core$Dict$empty,
		A2(
			$elm$core$Maybe$withDefault,
						...
						[
							...
							$mdgriffith$elm_ui$Element$px(
								$elm$core$Basics$ceiling(
									widthValueRatio * A2($elm$core$Basics$max, nodeValue, childrenValue)))),
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$text('Run: ' + model.filename)),
					A2(
					$mdgriffith$elm_ui$Element$column,
					_List_fromArray(
						[
								...
								A2(
									...
									A2(
										...
										$elm$core$Array$fromList(
											$elm$core$Dict$toList(model.run.data))))));
						return A2(
							$elm$core$List$map,
							function (metric) {
								return A2(
									...
									function () {
										...
										var data = A2(
											...
											model.run.data);
										var inclusiveData = $author$project$Main$addInclusive(data);
										var rootPath = A2(
											$elm$core$Maybe$withDefault,
											'',
											A2(
										...
										var rootValue = function () {
											var _v0 = A2($elm$core$Dict$get, rootPath, inclusiveData);
											if (_v0.$ === 'Just') {
												var _v1 = _v0.a;
												var val = _v1.a;
												var childrenVal = _v1.b;
												return A2($elm$core$Basics$max, val, childrenVal);
											} else {
												return 0;
											}
										}();
										return A2(
											...
											_List_fromArray(
												[
													...
													A3($author$project$Main$viewFlameGraph, inclusiveData, flameWidth / rootValue, rootPath)
												]));
									}());
							},
							metrics);
					...
					$author$project$Main$viewGlobals(model.run.meta))
				])));
};
